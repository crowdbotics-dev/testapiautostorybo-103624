...
## Project Structure
    ...
    ├── testapiautostorybo_103624  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_103624`
...
2. Clone this repo and `cd testapiautostorybo_103624`
